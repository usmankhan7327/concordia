...
import OurSite from "@/Pages/OurSite.vue";
import SearchProperty from "@/Pages/SearchProperty.vue";
import FeatureProperty from "@/Pages/FeatureProperty.vue";
...
<template>
    ...
    <div class="body-inner">
        ...
        <div id="slider" class="inspiro-slider slider-fullscreen dots-creative" data-fade="true">
            <!-- Slide 1 -->
            <div class="slide kenburns" data-bg-image="/images/slider/backgroundSlider.jpg">
                <div class="bg-overlay"></div>
                <div class="container">
                    <div class="slide-captions text-center text-light">
                        <!-- Captions -->
                        <h1 data-caption-animate="zoom-out">Welcome to the Concordia Construction</h1>
                        <p>Concordia Construction (Private) Limited is Islamabad-based supply and construction company. </p>
            ...
            <div class="slide" data-bg-video="video/pexels-waves.mp4">
                ...
                <div class="container">
                    <div class="slide-captions text-start text-light">
                        <!-- Captions -->
                        <h1>Concordia Construction </h1>
                        <p class="text-small">The primary purpose of the company is to maximize profits for its stakeholders while maintaining highest ethical standards.</p>
                        <div><a href="#welcome" class="btn btn-primary scroll-to">Explore more</a></div>
                        <!-- end: Captions -->
                    </div>
                </div>
...
<!--        <SearchProperty />-->
        ...
        <!-- end: SERVICES -->
        <!-- COUNTERS -->
        <section class="text-light p-t-150 p-b-150 " data-bg-parallax="images/parallax/29.jpg">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-3">
        ...
        <!-- end: COUNTERS -->
        <!-- CLIENTS -->
        <section id="clients" class="p-t-60">
            <div class="container">
                <div class="heading-text heading-section text-center">
                    <h2>CLIENTS</h2>
                    <span class="lead">Our awesome clients we've had the pleasure to work with! </span>
                </div>
                <div class="carousel client-logos" data-items="6" data-items-sm="4" data-items-xs="3" data-items-xxs="2" data-margin="20" data-arrows="false" data-autoplay="true" data-loop="true">
                    <div>
        ...
        <section class="p-5">
            <div class="container">
                <div class="row g-4">
                    <div id="map" style="width: 100%; height: 100%"><iframe src="https://www.google.com/maps/d/embed?mid=1_wV22amgac2Wt4gvMqstKu57Fg0&hl=en_US&ehbc=2E312F" width="640" height="480"></iframe></div>
                </div>
            </div>
        </section>
        <!-- end: map -->
